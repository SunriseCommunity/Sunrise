...
namespace Sunrise.Shared.Database.Migrations
{
    ...
    [Migration("20260510173606_LimitScoreHashTo32CharactersForScoreProcessing")]
    partial class LimitScoreHashTo32CharactersForScoreProcessing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sunrise.Shared.Database.Models.Scores.ScoreProcessingQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("score_processing_queue");
                });

            modelBuilder.Entity("Sunrise.Shared.Database.Models.Scores.ScoreTaskQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ActiveScoreId")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("CASE WHEN Status IN (0, 1) THEN ScoreId ELSE NULL END", true);

                    b.Property<int?>("ActiveScoreProcessingQueueId")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("int")
                        .HasComputedColumnSql("CASE WHEN Status IN (0, 1) THEN ScoreProcessingQueueId ELSE NULL END", true);
                    ...
                    b.Property<int?>("ScoreProcessingQueueId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ScoreProcessingQueueId");
                    ...
                    b.ToTable("score_task_queue", t =>
                        {
                            t.HasCheckConstraint("CK_score_task_queue_target", "((TaskType = 0 AND ScoreProcessingQueueId IS NOT NULL AND ScoreId IS NULL) OR (TaskType <> 0 AND ScoreProcessingQueueId IS NULL AND ScoreId IS NOT NULL))");
                        });
                });
            ...
            modelBuilder.Entity("Sunrise.Shared.Database.Models.Scores.ScoreTaskQueue", b =>
                {
                    ...
                    b.HasOne("Sunrise.Shared.Database.Models.Scores.ScoreProcessingQueue", "ScoreProcessingQueue")
                        .WithMany()
                        .HasForeignKey("ScoreProcessingQueueId");

                    b.Navigation("Score");

                    b.Navigation("ScoreProcessingQueue");
                });
