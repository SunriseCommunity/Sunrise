...
public static class SunriseMetrics
{
    ...
    public static void PacketHandlingCounterInc(BanchoPacket packet, IBaseSession session)
    {
    ...
    public static void ExternalApiRequestsCounterInc(ApiType type, ApiServer server, IBaseSession session)
    {
    ...
    public static void RequestReturnedErrorCounterInc(string requestType, IBaseSession? session, string? errorMessage)
    {
