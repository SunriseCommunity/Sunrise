...
{
    public static async Task<double> CalculatePerformancePoints(IBaseSession session, Score score)
    {
    ...
    public static async Task<double> RecalcuteBeatmapDifficulty(IBaseSession session, int beatmapId, int mode,
        Mods mods = Mods.None)
    {
    ...
    public static async Task<(double, double, double, double)> CalculatePerformancePoints(IBaseSession session,
