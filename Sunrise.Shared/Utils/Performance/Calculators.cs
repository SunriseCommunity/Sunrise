...
namespace Sunrise.Shared.Utils.Performance;

public static class Calculators
{
    public static async Task<double> CalculatePerformancePoints(BaseSession session, Score score)
    {
        var beatmapBytes = await BeatmapRepository.GetBeatmapFile(session, score.BeatmapId);
    ...
    public static async Task<double> RecalcuteBeatmapDifficulty(BaseSession session, int beatmapId, int mode,
        Mods mods = Mods.None)
    {
        var beatmapBytes = await BeatmapRepository.GetBeatmapFile(session, beatmapId);
        ...
        int beatmapId, int mode, Mods mods = Mods.None)
    {
        ...
        {
            var performance = RosuPP.Performance.New();
    ...
    private static RosuPP.Performance GetUserPerformance(Score score)
    {
