...
public class CalculateAccuracyTests : BaseTest
{
    ...
    [Fact]
    public void CalculateSubmittedScoreAccuracyForOsuStandardTest()
    {
        // Arrange
    ...
    [Fact]
    public void CalculateSubmittedScoreAccuracyForEmptyScoreTest()
    {
        // Arrange
        var score = new SubmittedScore
        {
    ...
    [Fact]
    public void CalculateSubmittedScoreAccuracyForOsuTaikoTest()
    {
        // Arrange
        var score = new SubmittedScore
        {
    ...
    [Fact]
    public void CalculateSubmittedScoreAccuracyForOsuCatchTheBeatTest()
    {
        // Arrange
        var score = new SubmittedScore
        {
    ...
    [Fact]
    public void CalculateSubmittedScoreAccuracyForOsuManiaTest()
    {
        // Arrange
        var score = new SubmittedScore
        {
    ...
    [Fact]
    public void CalculateSubmittedScoreAccuracyForOsuManiaV2Test()
    {
        // Arrange
        var score = new SubmittedScore
        {
